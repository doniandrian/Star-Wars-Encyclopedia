...
//adapter untuk menampilkan list people di species detail
class SpeciesDetailAdapter(val PeopleDetail: List<String>): RecyclerView.Adapter<SpeciesDetailAdapter.PeopleDetailViewHolder>() {
